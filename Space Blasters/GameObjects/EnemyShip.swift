...
//        let randomXEnd = CGFloat.random(min: gameSceneClass!.gameSpace.minX, max: gameSceneClass!.gameSpace.maxX) // Random Enemy End X-Axis position
        let randomXStart = CGFloat.random(min: 0.2, max: 0.8) // Random Enemy Start X-Axis position (Spawn Position)
        let randomXEnd = CGFloat.random(min: 0.2, max: 0.8) // Random Enemy End X-Axis position
        ...
        enemyShipNode.setScale(1.5) // Set Scale of Enemy Ship (1) being Normal
